...
-(void) createInputForTable
{
    ...
    mainMenuList.menuItems=[[NSMutableArray alloc] initWithObjects:@"Chat Room",@"Edit Templates",@"Chat Settings",@"FB likes as Interest",@"Statistics",@"MyChat Logs",@"Publice Logs",@"Share to Friends",@"Issues/Suggestions",nil];
    
    mainMenuList.menuImages=[[NSMutableArray alloc] initWithObjects:@"mnu_topstocks",@"mnu_settings",@"mnu_portfolio",@"mnu_orderpad",@"mnu_orderstatus",@"mnu_research",@"mnu_livetrade",@"mnu_news",@"mnu_topstocks",nil];
    
    mainMenuList.viewControllers=[[NSMutableArray alloc] initWithObjects:@"ChatHomeViewController",@"ChatLogsViewController",@"SettingsViewController",@"ChatLogsViewController",@"ChatLogsViewController",@"ChatLogsViewController",@"ChatLogsViewController",@"ChatLogsViewController",@"ChatLogsViewController",nil];
    
    mainMenuList.title=@"MainMenu";
    mainMenuList.viewKeys=[[NSMutableArray alloc] initWithObjects:@"ChatHomeView",@"ChatLogsView",@"SettingsView",@"ChatLogsView",@"ChatLogsView",@"ChatLogsView",@"ChatLogsView",@"ChatLogsView",@"ChatLogsView",nil];
...
-(UIView*) tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if(section!=0)
    {
        ...
        UILabel *sectionHeaderLbl=[[UILabel alloc] initWithFrame:CGRectMake(0,0,tableView.frame.size.width,30)];
